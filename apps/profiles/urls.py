...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[\w\._-]+)/field/Profile/(?P<fieldname>[\w_]+)/(?P<default>[\w_]*)$','profiles.views.profile_field',{"class":"Profile"},name='profile_field'),
    url(r'^(?P<username>[\w\._-]+)/field/HostInfo/(?P<fieldname>[\w_]+)/$','profiles.views.profile_field',{"class":"HostInfo"},name='host_info_profile_field'),
